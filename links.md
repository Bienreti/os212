...
#### 1. [Disk Scheduling Algorithms](https://www.geeksforgeeks.org/disk-scheduling-algorithms/?ref=lbp)

A really good place to start learning disk scheduling algorithms. It has a whole section talking about it. You can check that by looking at the sidebar.

#### 2. [Understanding the Linux Boot Process - CompTIA Linux+, LPIC-1 (YouTube)](https://www.youtube.com/watch?v=mHB0Z-HUauo)

Practical explanation of the linux boot process.

#### 3. [Free Raid Calculator](http://www.raid-calculator.com/)

Calculator of capacity, speed gain, and fault tolerance in disk with raid.

#### 4. [File Management A1Q2 Solution](https://www.site.uottawa.ca/~lucia/courses/2131-06/a1sol/A1Q2.htm)

Quick lookup to formulas related to disk.

---

#### 5. [Scheduling Policies - Georgia Tech - Advanced Operating Systems (YouTube)](https://www.youtube.com/watch?v=fQin6dsYTdE)

Explains the possible varieties of how the processor decides which thread to be processed first.

#### 6. [How to use mmap function in C language?](https://linuxhint.com/using_mmap_function_linux/)

Demonstration of mmap function in C.

#### 7. [How to get a file's size in C? (stat, fstat, fileno) (YouTube)](https://www.youtube.com/watch?v=FT2A2HQbTkU)

Concise video about fstat function in C.

---

#### 8. [Introduction of Process Synchronization](https://www.geeksforgeeks.org/introduction-of-process-synchronization/?ref=lbp)
...
#### 9. [Semaphore in OS | Practice Problems](https://www.gatevidyalay.com/semaphore-in-os-practice-problems/)

Same as above, but this one is for exercise. It also has a set of problems that can be accessed via the sidebar.

---

#### 10. [[03] Processes (pdf)](https://www.cl.cam.ac.uk/teaching/2021/OpSystems/pdf/03-Processes.pdf)

Structured, easy to understand, interactive explanation about process in OS. 

#### 11. [[04] Scheduling (pdf)](https://www.cl.cam.ac.uk/teaching/2021/OpSystems/pdf/04-Scheduling.pdf)

Scheduling explained in the most comprehensible way.

#### 12. [fork() in C](https://www.geeksforgeeks.org/fork-system-call/)

Best explanation of the fork() function on the internet (i guess). Besides clarity, it has many worked examples. Super useful!

#### 13. [Difference Between Fork And Exec](https://programmerbay.com/difference-between-fork-and-exec/)

It is very straightfoward. Good starting point to learn exec function(s). 

#### 14. [An Example Using execlp System Call (pdf)](https://www.albany.edu/~csi402/pdfs/handout_13.3.pdf?__cf_chl_captcha_tk__=pmd_v51.lciKi7KYeRkf8sF9HSBGZ03I_Snrp7CLDYx7jPA-1634094397-0-gqNtZGzNAzujcnBszQil)
...
#### 15. [07 Paging](https://github.com/mor1/ia-operating-systems/wiki/07-Paging)
...
#### 16. [Lecture 13: Demand Paging (YouTube)](https://www.youtube.com/watch?v=4KFZMaCenX4)
...
#### 17. [Pointers, Stack & Heap Memory, malloc() (pdf)](https://people.cs.clemson.edu/~jmarty/courses/commonCourseContent/Module2-ProgrammingReview/MemoryAndMalloc.pdf)
...
#### 18. [Pointer Arithmetic and Indexing, NULL and Void Pointer, and L-R Values (pdf)](http://web.cse.ohio-state.edu/~reeves.92/CSE2421au12/SlidesDay12_13.pdf)
...
#### 19. [Operating System - Memory Management](https://www.tutorialspoint.com/operating_system/os_memory_management.htm)
...
#### 20. [Fragmentation, External Fragmentation, Internal Fragmentation, first fit, best fit, worst fit in operating systems (OS)](https://t4tutorials.com/fragmentation-external-fragementation-internal-fragmentation-in-operating-systems-os/)
...
#### 21. [File System Concept (YouTube)](https://www.youtube.com/watch?v=mzUyMy7Ihk0)

A very brief introduction to file system that is actually easy to understand.

#### 22. [File System Implementation (pdf)](https://graphics.stanford.edu/~tolis/courses/csci4534-04-spring/lectures/8/ch12.pdf)
...
#### 23. [File Allocation Table (YouTube)](https://www.youtube.com/watch?v=V2Gxqv3bJCk)
...
#### 24. [NTFS and MFT (YouTube)](https://www.youtube.com/watch?v=h8Mb55ox5OE)
...
#### 25. [Inode Structure (YouTube)](https://www.youtube.com/watch?v=tMVj22EWg6A)
...
#### 26. [Hard links and Symbolic links — A comparison](https://medium.com/@307/hard-links-and-symbolic-links-a-comparison-7f2b56864cdd)
...
#### 27. [The unsolved math problem which could be worth a billion dollars (YouTube)](https://www.youtube.com/watch?v=8COArd_EREw)
...
#### 28. [Learn VIM while playing a game - VIM Adventures](https://vim-adventures.com/)
...
#### 29. [Malware: Difference Between Computer Viruses, Worms and Trojans (YouTube)](https://www.youtube.com/watch?v=n8mbzU0X2nQ)

Don't know what is the difference between types of computer viruses yet? then watch this.

#### 30. [What is PGP/GPG Encryption? In 3 Minutes - PGP/GPG Tutorial for Beginners (YouTube)](https://www.youtube.com/watch?v=1-MPcUHhXoc)

Short video explaining about PGP/GPG.

#### 31. [regex101: build, test, and debug regex](https://regex101.com/)
...
#### 32. [Pengertian CHMOD dan CHOWN untuk Ganti Permission di Linux](https://www.hostinger.co.id/tutorial/pengertian-chmod-dan-chown-untuk-ganti-permission-di-linux/)
